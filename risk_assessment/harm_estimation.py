...
from Cog_Dec_Mak.risk_assessment.helpers.harm_parameters import HarmParameters
from Cog_Dec_Mak.risk_assessment.helpers.properties import calc_crash_angle, get_obstacle_mass
from Cog_Dec_Mak.risk_assessment.utils.logistic_regression import (
    get_protected_log_reg_harm,
    get_unprotected_log_reg_harm,
)
from Cog_Dec_Mak.risk_assessment.utils.reference_speed import (
    get_protected_ref_speed_harm,
    get_unprotected_ref_speed_harm,
)
from Cog_Dec_Mak.risk_assessment.utils.reference_speed_symmetrical import (
...
from Cog_Dec_Mak.risk_assessment.utils.reference_speed_asymmetrical import (
    get_protected_inj_prob_ref_speed_complete,
    get_protected_inj_prob_ref_speed_reduced,
)
from Cog_Dec_Mak.risk_assessment.utils.gidas import (
    get_protected_gidas_harm,
    get_unprotected_gidas_harm,
)
from Cog_Dec_Mak.risk_assessment.utils.logistic_regression_symmetrical import (
...
from Cog_Dec_Mak.risk_assessment.utils.logistic_regression_asymmetrical import (
        ...
        if modes["crash_angle_simplified"] is False:
            ...
            for i in range(pred_length):
                with timer.time_with_cm(
                    ...
                    # get the ego harm and the harm of the collision opponent
