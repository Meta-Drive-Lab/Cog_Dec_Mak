...
from Cog_Dec_Mak.planner.planning import Planner
from Cog_Dec_Mak.planner.utils.timeout import Timeout
from Cog_Dec_Mak.planner.Frenet.utils.visualization import draw_frenet_trajectories
from Cog_Dec_Mak.planner.Frenet.utils.validity_checks import (
    VALIDITY_LEVELS,
)
from Cog_Dec_Mak.planner.Frenet.utils.helper_functions import (
    get_goal_area_shape_group,
)
from Cog_Dec_Mak.planner.Frenet.utils.prediction_helpers import (
...
from Cog_Dec_Mak.planner.Frenet.configs.load_json import (
    load_harm_parameter_json,
    load_planning_json,
    load_risk_json,
    load_weight_json,
)
from Cog_Dec_Mak.planner.Frenet.utils.frenet_functions import (
    calc_frenet_trajectories,
    get_v_list,
    sort_frenet_trajectories,
)
from Cog_Dec_Mak.planner.Frenet.utils.logging import FrenetLogging
from Cog_Dec_Mak.planner.utils.responsibility import assign_responsibility_by_action_space
from Cog_Dec_Mak.planner.utils import reachable_set
from Cog_Dec_Mak.risk_assessment.visualization.risk_visualization import (
    create_risk_files,
)
from Cog_Dec_Mak.risk_assessment.visualization.risk_dashboard import risk_dashboard
...
class FrenetPlanner(Planner):
    ...
    def _step_planner(self):
        ...
        with self.exec_timer.time_with_cm("simulation/calculate trajectories/total"):
            ...
            ft_list, space = calc_frenet_trajectories(
                c_s=c_s,
                c_s_d=c_s_d,
                c_s_dd=c_s_dd,
                c_d=c_d,
...
if __name__ == "__main__":
    ...
    if args.time:
        ...
        no_trajectores = settings_dict["frenet_settings"]["frenet_parameters"]["n_v_samples"] * len(settings_dict["frenet_settings"]["frenet_parameters"]["d_list"]) # 25
        import pstats
